...
const CreatePersona = () =>{
    ...
    const store = async(e)=>{
        e.preventDefault();
        await axios.post(endpoint, {nombre : nombre, apellido : apellido, nacionalidad : nacionalidad, localidad : localidad, direccion: direccion, dni : dni, fecha_nac : fecha_nac, telefono:telefono, email: email, tipo_atencion:tipo_atencion, tipo_persona : tipo_persona})
        navigate('/')
    }
    return(
        <div>
